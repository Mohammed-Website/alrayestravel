...
const sectionData = [
    ...
    {
        title: 'عروض جزيرة ياس',
        image_1: ['عروض-شركة-الريس-اكسبرس/ياس/1.jpg', 'رحلة جزيرة ياس | 4 أيام'],
    },


    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-الريس-اكسبرس/تايلاند/1.jpg', 'رحلة تايلاند | 10 أيام'],
    },

    {
        title: 'عروض موسكو',
        image_1: ['عروض-شركة-الريس-اكسبرس/موسكو/1.jpg', 'رحلة موسكو | 7 أيام'],
        image_2: ['عروض-شركة-الريس-اكسبرس/موسكو/2.jpg', 'رحلة موسكو | 7 أيام'],
    },

    {
        title: 'عروض بولندا',
        image_1: ['عروض-شركة-الريس-اكسبرس/بولندا/1.jpg', 'رحلة بولندا |  9 أيام'],
    },

    {
        title: 'عروض ميلان',
        image_1: ['عروض-شركة-الريس-اكسبرس/ميلان/1.jpg', 'رحلة ميلان |  7 أيام'],
        image_2: ['عروض-شركة-الريس-اكسبرس/ميلان/2.jpg', 'رحلة ميلان & كومو |  7 أيام'],
    },

    {
        title: 'عروض طرابزون',
        image_1: ['عروض-شركة-الريس-اكسبرس/طرابزون/1.jpg', 'رحلة طرابزون |  8 أيام'],
    },

    {
        title: 'عروض فيينا',
        image_1: ['عروض-شركة-الريس-اكسبرس/فيينا/1.jpg', 'رحلة يريفان | 7 أيام'],
    },
];
        ...
        .then(data => {
            ...
            data.reverse().forEach(item => { // Reverse to show newest first
                ...
                <div class="indoforall_clint_rate_info_div indoforall_animate_on_scroll">
                    <img src="مكتب-سياحي/مكتب-سياحي-بحريني.webp" alt="الريس اكسبرس للسفر والسياحة - مكتب سياحي" title="الريس اكسبرس للسفر والسياحة - مكتب سياحي">
                    <h4>${name}</h4>
                </div>
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97335119948";
